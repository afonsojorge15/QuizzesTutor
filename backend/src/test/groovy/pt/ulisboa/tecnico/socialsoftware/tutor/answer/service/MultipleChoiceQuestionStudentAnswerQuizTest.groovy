...
@DataJpaTest
class MultipleChoiceQuestionStudentAnswerQuizTest extends SpockTest {
    ...
    def 'conclude quiz without conclusionDate, without answering'() {
        ...
        correctAnswerDto.getCorrectAnswerDetails().getCorrectOptionId() == optionKO.getId()
    }
